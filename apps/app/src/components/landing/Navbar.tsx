  ...
  return (
    <div className=" flex pt-10  items-center  justify-between px-16">
      ...
      <div className=" flex items-center gap-4">
        ...
        <Button variant="ghost" className=" rounded-2xl paragraph-regular h-10" >Login</Button>
        <Button className=" rounded-2xl h-10  paragraph-regular">Get Started</Button>
        </div>
...
<DropdownMenu >
    ...
    <DropdownMenu >
      <DropdownMenuTrigger asChild>
      <Image   src="/icons/account.svg" alt="account" width={30} height={30}/>
      </DropdownMenuTrigger>
